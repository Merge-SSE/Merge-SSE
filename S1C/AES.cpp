...
int AES::Decrypt(byte_t *ciphertext, int ciphertext_len, byte_t *key, byte_t *plaintext) {
    EVP_CIPHER_CTX *ctx;
    ...
    /* Extract IV */
    byte_t iv[IV_len] = {};
    std::copy(ciphertext+ciphertext_len, ciphertext+ciphertext_len+IV_len, iv);
